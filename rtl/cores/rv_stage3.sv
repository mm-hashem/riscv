...
(
    ...
    logic zero_s3;
    pc_src_e pc_src_s3;
    logic [CFG_DATA_BYTES-1:0] byte_enable_s3;
    imm_src_e imm_src_dc;

    // Data Signals    
    xlen_st result_s3, read_data_s3,
...
`ifndef SYNTH
    ...
    assign dbg.a          = alu_result_s3; // todo rename
    assign dbg.result     = result_s3;
    assign dbg.wd         = write_data_sized_s3;
    ...
    assign dbg.data_size  = dc_s3_q.ctrl.data_ctrl.size;
    assign dbg.result_src = dc_s3_q.ctrl.result_src;
    assign dbg.rd_a       = dc_s3_q.ctrl.rd_a;
`endif
    ...
    mux4 #(.type_t(word_st)) mux4_pc_next (
        ...
        .i1 ({alu_result_s3[31:2], 2'b00}), // J, I: jalr: JTA = rs1 + imm
    ...
    always_ff @(posedge clk_i) begin : Fetch2DecodeReg
        if (rst_i || flush_dc) ft_dc_q <= 'x;
        else                   ft_dc_q <= ft_dc_d;
    end : Fetch2DecodeReg
     ...
     ************************/
     ...
     assign dc_s3_d.data.pc        = ft_dc_q.pc;
     assign dc_s3_d.data.pc_plus_4 = ft_dc_q.pc_plus_4;
     assign dc_s3_d.ctrl.rd_a      = reg_e'(ft_dc_q.instr[11:7]);

    controller controller_inst (
        .op_i        (opcode_e'(ft_dc_q.instr[6:0])),
        ...
        .imm_src_o   (imm_src_dc),              .alu_ctrl_o (dc_s3_d.ctrl.alu_ctrl),
    ...
    register_file register_file_inst (
        ...
        .rs1_a_i(reg_e'(ft_dc_q.instr[19:15])),
        .rs2_a_i(reg_e'(ft_dc_q.instr[24:20])),
        .rd_a_i (dc_s3_q.ctrl.rd_a),  .rd_d_i (result_s3),
    ...
    store_unit store_unit_inst (
        ...
        .byte_offset_i(alu_result_s3[CFG_BYTE_OFFSET-1:0]),
        .write_data_sized_o(write_data_sized_s3),
        .byte_enable_o(byte_enable_s3)
    );

    data_ram data_ram_inst (
        .clk_i, .rst_i,
        .we_i(dc_s3_q.ctrl.mem_write),
        .byte_enable_i(byte_enable_s3),
        .a_i (alu_result_s3),
